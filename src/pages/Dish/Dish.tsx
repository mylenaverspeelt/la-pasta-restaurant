...
export default function Dish() {
  ...
  return (
    <>
      <button className={style.voltar}>{"< Go Back"}</button>
...
// o useParams é um hook do react-router-dom que retorna um objeto (chave/valor) dos parametros dinamicos que foram definidos no route/path associados a esse componente, no arquivo de routes, de acordo de como você nomear ele lá, nesse caso foi o ID. DA PRA USAR ELE, POREM VAI SER UTILIZADO OUTRO HOOK.

// o useLocation retorna um objeto que mostra a localização atual de onde o usuário ta.
